...
export default function useProfile(){
    ...
    const projectSection = (<div className="w-[calc(100%-5em)] mx-[auto] overflow-x-hidden   "> { projects.map(project=> <ProjectCard key={project.id} id={project.id} title={project.title} tasks={project.tasks} createdAt={project.createdAt} />) } </div>);
